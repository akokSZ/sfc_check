...
Отчет получается в виде файлов cbs.log (общий файл для специалистов) и sfcdoc.log (основной, в UTF-8).
...
Стандартная проверка доступна для операционных систем Windows XP, Vista, 7 - 11 
...
Стандартная проверка доступна для операционных систем Windows 7 - 11 

Для операционных систем Windows 8 - 11 есть отдельный пункт "Очистить Хранилище компонентов", выполняющий соответствующую операцию по оптимизации пространства хранилища компонентов.
...
Доступно для Операционных систем Windows 7 - 11
